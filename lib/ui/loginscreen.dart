...
import '../uitlies/Appassets.dart';
import '../uitlies/Appcolor.dart';
import '../uitlies/Approutes.dart';
import '../uitlies/Appstyle.dart';
            ...
            child: Column(
                children: [
                  ...
                  ElevatedButton(
                    ...
                    child:GestureDetector(
                      onTap: () {
                        Navigator.pushNamed(context, AppRoutes.MovieDetialsRouteName);
                      },
                      child:  Text(
                        'Login',
                        style: AppStyle.blackfont20,
                      ),
                    ),
                  ...
                  Row(
                    children: <Widget>[
                      ...
                      Text(
                        "OR",
                        style: TextStyle(color: AppColor.yellowColor, fontSize: 14),
                      ),
                      Expanded(
                        child: Divider(
                          color:AppColor.yellowColor,
